...
margin_download(oecd |> select(year, country, variable, value), label="data")
...
margin_download(dina |> select(year, country, percentile,variable, type, revenu), label="data")
...
margin_download(evol |> select(year, country, variable, s10s50), label="data")
...
margin_download(full_dec |> select(year, country3, decile, variable, popr, revenu, seuilm, seuilp, revenu_moy), label="data")

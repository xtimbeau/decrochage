...
-   Dans la même lignée, l'explication selon laquelle la lourdeur du système social et la redistribution qu'elle implique pèserait sur la compétitivité (qui n'explique pas l'excédent courant européen), l'allocation des ressources de la dépense publique et les effets négatif sur l'offre de travail conduisant par exemple les plus productifs à quitter l'Europe pour d'autres cieux.
...
Ces éléments permettent de revenir sur l'analyse souvent faite d'une performance des Etats-Unis particulièrement forte. Si cette performance est incontestable, elle n'a pas du tout profité aux plus pauvres. Ceci explique le sentiment d'une situation économique très dégradé sous le mandat Biden et explique en partie le vote Trump. Ainsi, un examen un zoom du @fig-percentile présenté sur le @fig_zoom indique une croissance du revenu des 50% les moins riches assez nette de 2018 à 2020, interrompue ensuite, avec le COVID et la hausse des prix de l'énergie.
...
gg1(c("US"), "adiincj992", percentile=c("p0p50", "p50p90","p90p99", "p99p100")) + 
  scale_x_continuous(
    limits=c(2012, NA), breaks = seq(1980, 2020, by = 10),
    expand = expansion(add = c(2, 6) ) ) +
  scale_y_log10(
        limits = NULL,
        labels = scales::label_number(scale=1/1000, suffix = "k"),
  ...
  annotate("text", x=2019, y=290000, label="Trump I", hjust = 0.5, vjust=1)+
  ofce_caption(
    source = "World Inequality Database (WID), téléchargée le 10 mai 2025", ofce = FALSE, author = TRUE,
    code = "https://github.com/xtimbeau/decrochage")
```
